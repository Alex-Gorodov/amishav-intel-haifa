import { View, Text, StyleSheet, ScrollView, FlatList, TouchableOpacity, NativeSyntheticEvent, NativeScrollEvent, useWindowDimensions, Pressable } from 'react-native';
